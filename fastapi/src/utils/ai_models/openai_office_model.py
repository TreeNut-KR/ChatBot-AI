...
from .shared.shared_configs import OfficePrompt, OpenAICompletionConfig, BaseConfig

def build_openai_messages(character: OfficePrompt, user_input: str, chat_list: List[Dict]=None) -> list:
    """
...
class OpenAIChatModel:
    ...
    def generate_response_stream(self, input_text: str, search_text: str, chat_list: List[Dict]) -> Generator[str, None, None]:
        ...
        try:
            ...
            self.character_info=OfficePrompt(

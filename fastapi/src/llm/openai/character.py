"""
파일은 OpenAICharacterModel, character_config.CharacterPrompt 등등 클래스를 정의하고  OpenAI API를 사용하여,
...
def build_openai_messages(character_info: character_config.CharacterPrompt) -> list:
    """
